        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-6 md:p-8 space-y-4 text-sm md:text-base text-gray-900 border border-gray-200" style={{fontFamily: "'Inconsolata', monospace", backgroundColor: 'rgba(249, 249, 249, 0.5)'}}>
                <h3 className="text-lg md:text-xl font-bold mb-4" style={{fontFamily: "'Special Elite', serif", letterSpacing: '0.15em'}}>/// HOUSE ENGINEER</h3>
